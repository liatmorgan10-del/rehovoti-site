...
function EventCard({ ev, isAdmin, onDelete, onEdit }) {
  ...
  return (
    <div
      className="event-card-anim flex flex-col overflow-hidden rounded-2xl shadow-sm transition-transform duration-200 hover:-translate-y-0.5 active:scale-[0.98]"
